...
export const metadata = {
  title: "Corporate Wellbeing & Team Development | Lemuria",
      ...
      <section className="relative pt-40 pb-24 overflow-hidden bg-brand-teal">
        ...
        <div className="container relative z-10 px-6 mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-serif text-white tracking-tight leading-[1.1] mb-10 drop-shadow-premium">
            Corporate Wellbeing & <br /> <span className="text-brand-beige italic font-light">Team Development</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="mt-20 p-12 md:p-16 lg:p-20 bg-brand-bg rounded-[50px] border border-brand-teal/5 shadow-[0_20px_60px_rgba(45,90,71,0.08)] text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <a href="/contact?subject=Corporate Wellbeing Package" className="inline-flex items-center justify-center px-8 py-5 bg-brand-teal text-white rounded-full font-bold text-xs tracking-[0.2em] uppercase hover:bg-brand-text transition-colors shadow-premium">Request a Corporate Package</a>
              <a href="/contact?subject=Corporate Wellbeing Discovery Call" className="inline-flex items-center justify-center px-8 py-5 bg-white text-brand-text border border-brand-teal/10 rounded-full font-bold text-xs tracking-[0.2em] uppercase hover:bg-brand-teal/5 transition-colors shadow-premium">Book a Discovery Call</a>
            </div>
          </div>
